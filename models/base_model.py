#!/usr/bin/python3
"""This module defines a basemodel class that serves as the base for other classes in the system"""
import uuid
...
class BaseModel:
    ...
    if getenv("HBNB_TYPE_STORAGE") == 'db':
        id = Column(String(0), nullable=False, primary_key=True)
    ...
    def to_dict(sel, ssave_to_disk=False):
