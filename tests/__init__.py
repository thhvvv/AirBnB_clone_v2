#!/usr/bin/python3
""" This script has functions for file manipulation """
import os
...
def clear_stream(stream: TextIO):
    ...
    Args:
        ...
        If the stream is seekable, it seeks to the beginning and truncates its contents """
    if stream.seekable():
        stream.seek(0)
        stream.truncate(0)
...
def delete_file(file_path: str):
    ...
    Args:
        ...
        If file exists, its deleted using os.unlink(file_path) """
